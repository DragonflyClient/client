...
public class GuiUtilRenderComponents {
    ...
    public static List<IChatComponent> splitText(
            IChatComponent original, int maxTextLength, IFontRenderer fontRenderer, boolean trimSpace, boolean forceTextColor
    ) {
        int i = 0;
        ...
        for (int j = 0; j < listWithOriginal.size(); ++j) {
            ...
            if (i + i1 > maxTextLength) {
                String s2 = fontRenderer.trimStringToWidth(s4, maxTextLength - i);
