...
public class GuiPageButtonList extends GuiListExtended
{
    ...
    private final GuiResponder field_178076_z;
    ...
    private GuiTextField func_178068_a(int p_178068_1_, int p_178068_2_, EditBoxEntry p_178068_3_)
    {
        ...
        guitextfield.setGuiResponder(this.field_178076_z);
        ...
        if (this.field_178075_A instanceof GuiTextField)
        {
            ...
            if (!GuiScreen.isKeyComboCtrlV(p_178062_2_))
            {
                if (p_178062_2_ == 15)
                {
                    ...
                    int l = guitextfield.yPosition + this.entryHeight;
    ...
    public static class EditBoxEntry extends GuiListEntry
    {
        ...
        public EditBoxEntry(int p_i45534_1_, String p_i45534_2_, boolean p_i45534_3_, Predicate<String> p_i45534_4_)
        {
            ...
            this.field_178951_a = Objects.firstNonNull(p_i45534_4_, s -> true);
        }
    ...
    public static class GuiEntry implements IGuiListEntry
    {
        ...
        {
            this.func_178017_a(this.field_178029_b, yPos, 0, 0, true);
            this.func_178017_a(this.field_178030_c, yPos, 0, 0, true);
        }

        public boolean mousePressed(int slotIndex, int mouseX, int mouseY, int mouseEvent, int relativeX, int relativeY)
        {
            boolean flag = this.func_178026_a(this.field_178029_b, mouseX, mouseY, mouseEvent);
            boolean flag1 = this.func_178026_a(this.field_178030_c, mouseX, mouseY, mouseEvent);
            return flag || flag1;
        }
