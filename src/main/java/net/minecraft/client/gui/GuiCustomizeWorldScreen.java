...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder
{
    ...
    private void func_175325_f()
    {
        ...
        GuiPageButtonList.GuiListEntry[] aguipagebuttonlist$guilistentry3 = new GuiPageButtonList.GuiListEntry[] {new GuiPageButtonList.GuiLabelEntry(400, I18n.format("createWorld.customize.custom.mainNoiseScaleX") + ":", false), new GuiPageButtonList.EditBoxEntry(132, String.format("%5.3f",
            Float.valueOf(this.field_175336_F.mainNoiseScaleX)), false, this.field_175332_D), new GuiPageButtonList.GuiLabelEntry(401, I18n.format("createWorld.customize.custom.mainNoiseScaleY") + ":", false), new GuiPageButtonList.EditBoxEntry(133, String.format("%5.3f",
            Float.valueOf(this.field_175336_F.mainNoiseScaleY)), false, this.field_175332_D::test), new GuiPageButtonList.GuiLabelEntry(402, I18n.format("createWorld.customize.custom.mainNoiseScaleZ") + ":", false), new GuiPageButtonList.EditBoxEntry(134, String.format("%5.3f",
            Float.valueOf(this.field_175336_F.mainNoiseScaleZ)), false, this.field_175332_D::test), new GuiPageButtonList.GuiLabelEntry(403, I18n.format("createWorld.customize.custom.depthNoiseScaleX") + ":", false), new GuiPageButtonList.EditBoxEntry(135, String.format("%5.3f",
            Float.valueOf(this.field_175336_F.depthNoiseScaleX)), false, this.field_175332_D::test), new GuiPageButtonList.GuiLabelEntry(404, I18n.format("createWorld.customize.custom.depthNoiseScaleZ") + ":", false), new GuiPageButtonList.EditBoxEntry(136, String.format("%5.3f",
            Float.valueOf(this.field_175336_F.depthNoiseScaleZ)), false, this.field_175332_D::test), new GuiPageButtonList.GuiLabelEntry(405, I18n.format("createWorld.customize.custom.depthNoiseScaleExponent") + ":", false), new GuiPageButtonList.EditBoxEntry(137, String.format("%2.3f",
            Float.valueOf(this.field_175336_F.depthNoiseScaleExponent)), false, this.field_175332_D::test), new GuiPageButtonList.GuiLabelEntry(406, I18n.format("createWorld.customize.custom.baseSize") + ":", false), new GuiPageButtonList.EditBoxEntry(138, String.format("%2.3f",
            Float.valueOf(this.field_175336_F.baseSize)), false, this.field_175332_D::test), new GuiPageButtonList.GuiLabelEntry(407, I18n.format("createWorld.customize.custom.coordinateScale") + ":", false), new GuiPageButtonList.EditBoxEntry(139, String.format("%5.3f",
            Float.valueOf(this.field_175336_F.coordinateScale)), false, this.field_175332_D::test), new GuiPageButtonList.GuiLabelEntry(408, I18n.format("createWorld.customize.custom.heightScale") + ":", false), new GuiPageButtonList.EditBoxEntry(140, String.format("%5.3f",
            Float.valueOf(this.field_175336_F.heightScale)), false, this.field_175332_D::test), new GuiPageButtonList.GuiLabelEntry(409, I18n.format("createWorld.customize.custom.stretchY") + ":", false), new GuiPageButtonList.EditBoxEntry(141, String.format("%2.3f",
            Float.valueOf(this.field_175336_F.stretchY)), false, this.field_175332_D::test), new GuiPageButtonList.GuiLabelEntry(410, I18n.format("createWorld.customize.custom.upperLimitScale") + ":", false), new GuiPageButtonList.EditBoxEntry(142, String.format("%5.3f",
            Float.valueOf(this.field_175336_F.upperLimitScale)), false, this.field_175332_D::test), new GuiPageButtonList.GuiLabelEntry(411, I18n.format("createWorld.customize.custom.lowerLimitScale") + ":", false), new GuiPageButtonList.EditBoxEntry(143, String.format("%5.3f",
            Float.valueOf(this.field_175336_F.lowerLimitScale)), false, this.field_175332_D::test), new GuiPageButtonList.GuiLabelEntry(412, I18n.format("createWorld.customize.custom.biomeDepthWeight") + ":", false), new GuiPageButtonList.EditBoxEntry(144, String.format("%2.3f",
            Float.valueOf(this.field_175336_F.biomeDepthWeight)), false, this.field_175332_D::test), new GuiPageButtonList.GuiLabelEntry(413, I18n.format("createWorld.customize.custom.biomeDepthOffset") + ":", false), new GuiPageButtonList.EditBoxEntry(145, String.format("%2.3f",
            Float.valueOf(this.field_175336_F.biomeDepthOffset)), false, this.field_175332_D::test), new GuiPageButtonList.GuiLabelEntry(414, I18n.format("createWorld.customize.custom.biomeScaleWeight") + ":", false), new GuiPageButtonList.EditBoxEntry(146, String.format("%2.3f",
            Float.valueOf(this.field_175336_F.biomeScaleWeight)), false, this.field_175332_D::test), new GuiPageButtonList.GuiLabelEntry(415, I18n.format("createWorld.customize.custom.biomeScaleOffset") + ":", false), new GuiPageButtonList.EditBoxEntry(147, String.format("%2.3f",
            Float.valueOf(this.field_175336_F.biomeScaleOffset)), false, this.field_175332_D::test)};
    ...
    public void setEntryValue (int id, String value)
    {
        ...
        if (f1 != f && f != 0.0F)
        {
            ((GuiTextField)this.field_175349_r.func_178061_c(id)).setText(this.func_175330_b(id, f1));
        }

        ((GuiSlider)this.field_175349_r.func_178061_c(id - 132 + 100)).setSliderValue(f1, false);
    ...
    public void setEntryValue (int id, boolean value)
    {
        ...
        {
            case 148:
                this.field_175336_F.useCaves = value;
                break;

            case 149:
                this.field_175336_F.useDungeons = value;
                break;

            case 150:
                this.field_175336_F.useStrongholds = value;
                break;

            case 151:
                this.field_175336_F.useVillages = value;
                break;

            case 152:
                this.field_175336_F.useMineShafts = value;
                break;

            case 153:
                this.field_175336_F.useTemples = value;
                break;

            case 154:
                this.field_175336_F.useRavines = value;
                break;

            case 155:
                this.field_175336_F.useWaterLakes = value;
                break;

            case 156:
                this.field_175336_F.useLavaLakes = value;
                break;

            case 161:
                this.field_175336_F.useLavaOceans = value;
                break;

            case 210:
                this.field_175336_F.useMonuments = value;
        }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        drawCenteredString(this.fontRendererObj, this.field_175341_a, this.width / 2, 2, 16777215);
        drawCenteredString(this.fontRendererObj, this.field_175333_f, this.width / 2, 12, 16777215);
        drawCenteredString(this.fontRendererObj, this.field_175335_g, this.width / 2, 22, 16777215);
