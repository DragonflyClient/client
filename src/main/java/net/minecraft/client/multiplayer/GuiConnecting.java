...
import net.inceptioncloud.dragonfly.event.play.ServerConnectingEvent;
        ...
        new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet())
        {
            public void run ()
            {
                ...
                try {
                    ...
                    GuiConnecting.this.networkManager = NetworkManager.createNetworkManagerAndConnect(inetaddress, port, GuiConnecting.this.mc.gameSettings.useUsingNativeTransport());
