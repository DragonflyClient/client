...
object KeystrokesMod : DragonflyMod("Keystrokes") {
    ...
    override fun publishControls(): List<ControlElement<*>> = listOf(
        ...
        NumberControl(!KeystrokesMod::animationSpeed, "Animation Speed (seconds)", "Duration of the text fade-in animation", min = 0.0, max = 1.0, decimalPlaces = 2, liveUpdate = true)
    )
