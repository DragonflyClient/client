...
public class CraftingManager
{
    ...
    /**
     * Adds a recipe to the games recipe list.
     */
    public ShapedRecipes addRecipe(ItemStack stack, Object... recipeComponents)
    {
        ...
        {
            String[] stringArray = (String[]) recipeComponents[i++];
        ...
        ItemStack[] itemStackArray = new ItemStack[j * k];
        ...
        for (int i1 = 0; i1 < j * k; ++i1)
        {
            ...
            if (map.containsKey(c0)) {
                itemStackArray[i1] = map.get(c0).copy();
            } else {
                itemStackArray[i1] = null;
            }
        }

        ShapedRecipes shapedrecipes = new ShapedRecipes(j, k, itemStackArray, stack);
        this.recipes.add(shapedrecipes);
        return shapedrecipes;
    }

    /**
     * Adds a crafting recipe to the the game.
     */
    ...
    public ItemStack[] func_180303_b(InventoryCrafting p_180303_1_, World worldIn)
    {
        ...
        ItemStack[] itemStackArray = new ItemStack[p_180303_1_.getSizeInventory()];

        for (int i = 0 ; i < itemStackArray.length ; ++i) {
            itemStackArray[i] = p_180303_1_.getStackInSlot(i);
        }
