            ...
            try {
                (new Thread(() ->
                {
                    SoundSystemConfig.setLogger(new SoundSystemLogger()
                    {
                        ...
                        public void importantMessage (String message, int i)
                        {
                            if (!message.isEmpty()) {
                        ...
                        public void errorMessage (String classReference, String message, int i)
                        {
                            if (!message.isEmpty()) {
                                SoundManager.logger.error("Error in class '" + classReference + "'");
