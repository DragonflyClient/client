...
public class GuiIngestServers extends GuiScreen
{
    ...
    class ServerList extends GuiSlot
    {
        ...
        protected void drawSlot(int entryID, int x, int y, int height, int mouseXIn, int mouseYIn)
        {
            ...
            drawString(GuiIngestServers.this.fontRendererObj, ingestserver.serverName, x + 2, y + 5, 16777215);
            drawString(GuiIngestServers.this.fontRendererObj, s, x + 2, y + GuiIngestServers.this.fontRendererObj.FONT_HEIGHT + 5 + 3, 3158064);
            drawString(GuiIngestServers.this.fontRendererObj, s1, this.getScrollBarX() - 5 - GuiIngestServers.this.fontRendererObj.getStringWidth(s1), y + 5, 8421504);

            if (s2 != null)
            {
                drawString(GuiIngestServers.this.fontRendererObj, s2, this.getScrollBarX() - 5 - GuiIngestServers.this.fontRendererObj.getStringWidth(s2), y + 5 + 3 + GuiIngestServers.this.fontRendererObj.FONT_HEIGHT, 8421504);
            }
        }
