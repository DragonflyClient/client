...
public class GuiMerchant extends GuiContainer
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (merchantrecipelist != null && !merchantrecipelist.isEmpty())
        {
            ...
            this.itemRender.renderItemOverlays(itemstack, i + 36, j + 24);

            if (itemstack1 != null)
            {
                this.itemRender.renderItemAndEffectIntoGUI(itemstack1, i + 62, j + 24);
                this.itemRender.renderItemOverlays(itemstack1, i + 62, j + 24);
            }

            this.itemRender.renderItemAndEffectIntoGUI(itemstack2, i + 120, j + 24);
            this.itemRender.renderItemOverlays(itemstack2, i + 120, j + 24);
