...
public class GuiSnooper extends GuiScreen
{
    ...
    class List extends GuiSlot
    {
        ...
        {
            GuiSnooper.this.fontRendererObj.drawString(GuiSnooper.this.field_146604_g.get(entryID), 10, y, 16777215);
            GuiSnooper.this.fontRendererObj.drawString(GuiSnooper.this.field_146609_h.get(entryID), 230, y, 16777215);
        }
