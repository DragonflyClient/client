    ...
    public void loadTextureAtlas(IResourceManager resourceManager)
    {
        ...
        for (Object entry : this.mapRegisteredSprites.entrySet())
        {
            ...
            if (!textureatlassprite1.hasCustomLoader(resourceManager, resourcelocation))
            {
                    ...
                    if (texturemetadatasection != null)
                    {
                        ...
                        while (iterator.hasNext())
                        {
                            ...
                            if (j3 > 0 && j3 < abufferedimage.length - 1 && abufferedimage[j3] == null)
                            {
                                ...
                                {
                                    logger.error("Unable to load miplevel {} from: {}", Integer.valueOf(j3), resourcelocation2, ioexception);
                                }
                            }
                        }
                    }
                ...
                if (k2 < k)
                {
                    logger.warn("Texture {} with size {}x{} limits mip level from {} to {}", resourcelocation1, Integer.valueOf(textureatlassprite1.getIconWidth()), Integer.valueOf(textureatlassprite1.getIconHeight()), Integer.valueOf(MathHelper.calculateLogBaseTwo(k)), Integer.valueOf(MathHelper.calculateLogBaseTwo(k2)));
                    k = k2;
                }
        ...
        {
            logger.info("{}: dropping miplevel from {} to {}, because of minimum power of two: {}", this.basePath, Integer.valueOf(this.mipmapLevels), Integer.valueOf(j2), Integer.valueOf(i2));
