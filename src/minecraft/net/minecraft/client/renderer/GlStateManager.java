...
public class GlStateManager
{
    ...
    private static GlStateManager.AlphaState alphaState = new GlStateManager.AlphaState(null);
    ...
    private static GlStateManager.ColorMaterialState colorMaterialState = new GlStateManager.ColorMaterialState(null);
    private static GlStateManager.BlendState blendState = new GlStateManager.BlendState(null);
    private static GlStateManager.DepthState depthState = new GlStateManager.DepthState(null);
    private static GlStateManager.FogState fogState = new GlStateManager.FogState(null);
    private static GlStateManager.CullState cullState = new GlStateManager.CullState(null);
    private static GlStateManager.PolygonOffsetState polygonOffsetState = new GlStateManager.PolygonOffsetState(null);
    private static GlStateManager.ColorLogicState colorLogicState = new GlStateManager.ColorLogicState(null);
    private static GlStateManager.TexGenState texGenState = new GlStateManager.TexGenState(null);
    private static GlStateManager.ClearState clearState = new GlStateManager.ClearState(null);
    private static GlStateManager.StencilState stencilState = new GlStateManager.StencilState(null);
    ...
    private static GlStateManager.ColorMask colorMaskState = new GlStateManager.ColorMask(null);
